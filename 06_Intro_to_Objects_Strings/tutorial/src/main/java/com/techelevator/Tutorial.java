...
public class Tutorial {
    ...
    public static void main(String[] args) {
        ...
        String slutation = new String("Welcome my friend");
        System.out.println("Salutation: " + slutation);
        String toast = "May the compiler rise to meet you";
        ...
        System.out.println("Enter secret word (hint: it's '" + secretWord + "') ");
        ...
        boolean matchingEqualsIgnoreCase = secretWord.equalsIgnoreCase(userSecretWord);
        System.out.println("Using '.equalsIgnoreCase(): " +matchingEqualsIgnoreCase);

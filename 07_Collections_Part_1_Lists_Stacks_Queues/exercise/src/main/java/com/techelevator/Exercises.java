...
public class Exercises {
    ...
    public String[] list2Array(List<String> stringList) {
        ...
        for (int i = 0; i < arrayFromList.length; i++) {
            arrayFromList[i] = stringList.get(i);
        }
    ...
    public List<Double> arrayInt2ListDouble(int[] intArray) {
        List<Double> arrayHalved = new ArrayList<Double>();
        int i = 0;
        for (double item : intArray) {
            arrayHalved.add(Double.valueOf(intArray[i]) / 2);
            i++;
    ...
    ** INTERVIEW QUESTION **
    ...
    public List<String> fizzBuzzList(Integer[] integerArray) {
        ...
        for (int number : integerArray) {
            if (integerArray[i] % 3 == 0 && integerArray[i] % 5 == 0 && integerArray[i] != 0) {
                fizzBuzz.add(i,"FizzBuzz");
            } else if (integerArray[i] % 3 == 0 && integerArray[i] != 0) {

                fizzBuzz.add(i,"Fizz");
            } else if (integerArray[i] % 5 == 0 && integerArray[i] != 0) {
                fizzBuzz.add(i,"Buzz");
            } else {
                fizzBuzz.add(i,integerArray[i].toString());
            }
            i++;
        }
        return fizzBuzz;
